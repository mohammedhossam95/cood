...
class FilterUserByCategoryRespModel extends BaseOneResponse {
  ...
  factory FilterUserByCategoryRespModel.fromJson(Map<String, dynamic> json) =>
      FilterUserByCategoryRespModel(
        status: json["status"],
...
class Result extends ResultEntity {
  ...
  Map<String, dynamic> toJson() => {
        "category": (category as UserCategory?)?.toJson(),
        "users": users == null
            ? []
            : List<dynamic>.from(users!.map((x) => (x as User?)?.toJson())),
      };
}
  ...
  Map<String, dynamic> toJson() => {
        ...
        "social_media_links": socialMediaLinks == null
            ...
            : List<dynamic>.from(socialMediaLinks!
                .map((x) => (x as SocialMediaLink?)?.toJson())),
      };
}
