...
class GetAllSocialMediaUseCase extends UseCase<BaseListResponse, NoParams>{
  final HomeRepo repository; 

  GetAllSocialMediaUseCase(this.repository);
 @override
  Future<Either<Failure, BaseListResponse>> call(NoParams params) async {
    return await repository.getAllSocialMedia();
  }
}