...
class ReservationRepositryImpl extends ReservationRepositry {
  final ReservationRemoteDataSource remoteDataSource;
  ReservationRepositryImpl({required this.remoteDataSource});
  @override
  Future<Either<Failure, BaseListResponse>> fetchReservation() async {
    if (await networkInfo.isConnected) {
      try {
        final response = await remoteDataSource.getReservationRemoteData();
